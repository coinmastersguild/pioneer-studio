#!/usr/bin/env node
// meshy2vrm.mjs — turn a Meshy rigged .glb into a VRM 0.x the DegenQuest client loads.
//
...
// auto-rig is a 24-joint Mixamo-style humanoid; the game's VRMs are VRM 0.x with
// the SAME bone topology. So all we add is the VRM "humanoid bone map" extension.
...
//   2. Meshy faces +Z (left side at +X); the game's VRM0s face -Z. A 180° yaw
