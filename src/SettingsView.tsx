...
// pipeline writes until server sync ships (pipeline.ts, api.ts ponytail notes).
  ...
  return (
    <div className="media-wrap">
      ...
      <div>
        ...
        <div className="sub" style={{ marginBottom: 10 }}>
          Your storyboard and pipeline are cached in this browser until server sync ships. Clearing resets them here only.
        </div>
