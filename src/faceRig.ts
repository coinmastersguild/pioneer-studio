...
/** Conservative viseme ceiling for authored VRMs with fragile morph targets.
 *  Some assets show lower-lip separation and mouth-corner artifacts at stronger
 *  weights. The lower ceiling trades articulation range for stable geometry. */
