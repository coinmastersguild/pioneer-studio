// ARDY Core skeleton (cskel27) — the 27-joint hierarchy + T-pose rest positions
// ARDY's `core` checkpoint generates motion for. Generated from
// nvidia/ARDY `ardy/assets/skeletons/cskel27/joints.p` +
// `ardy/skeleton/definitions.py: CoreSkeleton27` (Apache-2.0) — do not hand-edit.
//
...
// Using ARDY's own joint set means M2 motion drops straight onto these actors with
